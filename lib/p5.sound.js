 ...
 *  </p>
 *  <ul>
 *  <li><a href="#/p5.SoundFile"><b>p5.SoundFile</b></a>: Load and play sound
 * files.</li>
 *  <li><a href="#/p5.Amplitude"><b>p5.Amplitude</b></a>: Get the current
 * volume of a sound.</li>
 *  <li><a href="#/p5.AudioIn"><b>p5.AudioIn</b></a>: Get sound from an input
 * source, typically a computer microphone.</li>
 *  <li><a href="#/p5.FFT"><b>p5.FFT</b></a>: Analyze the frequency of sound.
 * Returns results from the frequency spectrum or time domain (waveform).</li>
 *  <li><a href="#/p5.Oscillator"><b>p5.Oscillator</b></a>: Generate Sine,
 *    Triangle, Square and Sawtooth waveforms. Base class of
 *    <li><a href="#/p5.Noise">p5.Noise</a> and <a
 * href="#/p5.Pulse">p5.Pulse</a>.
 *    </li>
 *  <li>
 *    <a href="#/p5.MonoSynth">p5.MonoSynth</a> and <a
 * href="#/p5.PolySynth">p5.PolySynth</a>: Play musical notes
 *  </li>
 ...
 *  <li><a href="#/p5.Filter"><b>p5.Filter</b></a>: Filter the frequency range
 * of a sound.
 *  </li>
 *  <li><a href="#/p5.Reverb"><b>p5.Reverb</b></a>: Add reverb to a sound by
 * specifying duration and decay. </li>
 *  <b><li><a href="#/p5.Convolver">p5.Convolver</a>:</b> Extends
 *  <a href="#/p5.Reverb">p5.Reverb</a> to simulate the sound of real
 *    physical spaces through convolution.</li>
 *  <b><li><a href="#/p5.SoundRecorder">p5.SoundRecorder</a></b>: Record sound
 * for playback
 *    / save the .wav file.
 *  <b><li><a href="#/p5.SoundLoop">p5.SoundLoop</a>, <a
 * href="#/p5.Phrase">p5.Phrase</a></b>, <b><a href="#/p5.Part">p5.Part</a></b>
 * and
 ...
 *  <p>p5.sound is on <a
 * href="https://github.com/processing/p5.js-sound/">GitHub</a>. Download the
 * latest version
 *  <a
 * href="https://github.com/processing/p5.js-sound/blob/master/lib/p5.sound.js">here</a>.</p>
 *
 *  @module p5.sound
 *  @submodule p5.sound
 *  @for p5.sound
 ...
 *   - TONE.js (c) Yotam Mann. Licensed under The MIT License (MIT).
 * https://github.com/TONEnoTONE/Tone.js
 *   - buzz.js (c) Jay Salvat. Licensed under The MIT License (MIT).
 ...
 * The audio element (el) will only be used to test browser support for various
 * audio formats
 */
 ...
 * <a
 * href="/docs/reference/#/p5.SoundFile/saveBlob">`p5.SoundFile.saveBlob`</a>.
 *
 *  @for p5
 *  @method saveSound
 ...
 *  @param {Function} [successCallback]   Name of a function to call once file
 *     loads
 *  @param {Function} [errorCallback]   Name of a function to call if file
 *     fails to load. This function will receive an error or XMLHttpRequest
 *     object with information about what went wrong.
 *  @param {Function} [whileLoadingCallback]   Name of a function to call while
 *     file is loading. That function will receive progress of the request to
 *     load the sound file
 *                                             (between 0 and 1) as its first
 *                                             parameter. This progress
 *                                             does not account for the
 *     additional time needed to decode the audio data.
 *
 *  @example
 *  <div><code>
 *  let mySound;
...
function () {
  ...
  soundfile_createClass(SoundFile, [{
     ...
     * @method play
     * @for p5.SoundFile
     * @param {Number} [startTime]            (optional) schedule playback to
     *     start (in seconds from now).
     * @param {Number} [rate]             (optional) playback rate
     * @param {Number} [amp]              (optional) amplitude (volume)
     *                                     of playback
     * @param {Number} [cueStart]        (optional) cue start time in seconds
     * @param {Number} [duration]          (optional) duration of playback in
     *     seconds
     */
     ...
     * pitch. Values less than zero will reverse the audio buffer.
     *
     *  @method rate
     *  @for p5.SoundFile
     *  @param {Number} [playbackRate]     Set the playback rate. 1.0 is
     *     normal,
     *                                     .5 is half-speed, 2.0 is twice as
     *     fast. Values less than zero play backwards.
     *  @example
     *  <div><code>
     *  let mySound;
     *
     ...
     * the
     * .wav-encoded audio data as a "<a target="_blank" title="Blob reference
     * at
     * MDN"
     ...
     * an <a href="/reference/#/p5/httpDo">http</a> request. We'll use the
     * `httpDo` options object to send a POST request with some specific
     * options: we encode the request as `multipart/form-data`, and attach the
 ...
 *  @param {Function} [whileLoading] Name of a function to call while file is
 *     loading. This function will receive the percentage loaded so far, from
 *     0.0 to 1.0.
...
function () {
  ...
  amplitude_createClass(Amplitude, [{
     ...
     *  @method getLevel
     *  @for p5.Amplitude
     *  @param {Number} [channel] Optionally return only channel 0 (left) or 1
     *     (right)
...
function () {
  ...
  fft_createClass(FFT, [{
     ...
     * represent a snapshot of amplitude readings in a single buffer. Length
     * will be equal to bins (defaults to 1024). Can be used to draw the
     * waveform of a sound.
     *
     *  @method waveform
     *  @for p5.FFT
     ...
     *                            16 and 1024. Defaults to 1024.
     *  @param {String} [precision] If any value is provided, will return
     *     results in a Float32 Array which is more precise than a regular
     *     array.
    ...
    /**
     *  Returns the
     *  <a href="http://en.wikipedia.org/wiki/Spectral_centroid"
     * target="_blank"> spectral centroid</a> of the input signal.
     ...
     *  @method  getCentroid
     *  @for p5.FFT
     *  @return {Number}   Spectral Centroid Frequency  of the spectral
     *     centroid in Hz.
     *
     *
     * @example
     ...
     *
     *  centroidplot = map(log(mean_freq_index), 0, log(spectrum.length), 0,
     *     width);
     *
     ...
     *  @return {Array}   linearAverages   Array of average amplitude values
     *     for each group
     */
     ...
     * given set of <a href="https://en.wikipedia.org/wiki/Octave_band"
     ...
     *  @method  logAverages
     *  @for p5.FFT
     *  @param  {Array}   octaveBands    Array of Octave Bands objects for
     *     grouping
     *  @return {Array}   logAverages    Array of average amplitude values for
     *     each group
     */
     ...
     * target="_blank">Octave Bands</a> N defaults to 3 and minimum central
     * frequency to 15.625Hz.
     *  (1/3 Octave Bands ~= 31 Frequency Bands)
     *  Setting fCtr0 to a central value of a higher octave will ignore the
     * lower bands and produce less frequency groups.
     *
     *  @method   getOctaveBands
     *  @for p5.FFT
     *  @param  {Number}  N             Specifies the 1/N type of generated
     *     octave bands
     *  @param  {Number}  fCtr0         Minimum central frequency for the
     *     lowest band
     *  @return {Array}   octaveBands   Array of octave band objects with their
     *     bounds
     */
...
function () {
  ...
  oscillator_createClass(Oscillator, [{
     ...
     *  @method  getType
     *  @for p5.Oscillator
     *  @returns {String} type of oscillator  eg . 'sine', 'triangle',
     *     'sawtooth' or 'square'.
     */
     ...
     *  @for p5.Oscillator
     *
     *  @returns {number} panPosition of oscillator , between Left (-1) and
     *     Right (1)
     */
 ...
 * p5.Envelope can control an Oscillator's frequency like this:
 * <code>osc.freq(env)</code>.</p>
 *  <p>Use <code><a href="#/p5.Envelope/setRange">setRange</a></code> to change
 * the attack/release level. Use <code><a
 * href="#/p5.Envelope/setADSR">setADSR</a></code> to change attackTime,
 * decayTime, sustainPercent and releaseTime.</p>
 *  <p>Use the <code><a href="#/p5.Envelope/play">play</a></code> method to
 * play the entire envelope, the <code><a
 * href="#/p5.Envelope/ramp">ramp</a></code> method for a pingable trigger, or
 * <code><a href="#/p5.Envelope/triggerAttack">triggerAttack</a></code>/
 ...
 *  @param {Number} [susRatio]    Ratio between attackLevel and releaseLevel,
 *     on a scale from 0 to 1, where 1.0 = attackLevel, 0.0 = releaseLevel. The
 *     susRatio determines the decayLevel and the level at which the sustain
 *     portion of the envelope will sustain. For example, if attackLevel is
 *     0.4, releaseLevel is 0, and susAmt is 0.5, the decayLevel would be 0.2.
 *     If attackLevel is increased to 1.0 (using <code>setRange</code>), then
 *     decayLevel would increase proportionally, to become 0.5.
 ...
 * decayTime)</a></code> as <a
 * href="https://en.wikipedia.org/wiki/RC_time_constant"> time constants</a>
 * for simple exponential ramps. If the value is higher than current value, it
 * uses attackTime, while a decrease uses decayTime.
 *
 *  @method  ramp
 *  @for p5.Envelope
 *  @param  {Object} unit           p5.sound Object or Web Audio Param
 ...
 *  Stream</a> API, which is not supported by certain browsers. Access in
 * Chrome browser is limited to localhost and https, but access over http may
 * be limited.</em></p>
 *
 *  @class p5.AudioIn
 *  @constructor
...
function () {
  ...
  audioin_createClass(AudioIn, [{
     ...
     * @method  getSources
     * @for p5.AudioIn
     * @param  {Function} [successCallback] This callback function handles the
     *     sources when they have been enumerated. The callback function
     *     receives the deviceList array as its only argument
     * @param  {Function} [errorCallback] This optional callback receives the
     *     error message as its argument.
     * @returns {Promise} Returns a Promise that can be used in place of the
     *     callbacks, similar to the enumerateDevices() method
     * @example
     *  <div><code>
     *  let audioIn;
     *
 ...
 *                              to the wet signal to this gain node, so that
 *     dry and wet signals are mixed properly.
 */
...
function (_Effect) {
  ...
  filter_createClass(Filter, [{
     ...
     * This is distinctly different from .amp() which is inherited from
     * p5.Effect
...
function (_Effect) {
  ...
  function Panner3D() {
     ...
     * [Panning
     * Model](https://www.w3.org/TR/webaudio/#idl-def-PanningModelType)
...
function (_Effect) {
  ...
  delay_createClass(Delay, [{
     ...
     * because it will increase the overall output each time through the loop,
     ...
     *                              frequencies higher than the filter
     *     frequency.
     *  @param {Number|Object} res  Resonance of the filter frequency
     *                              cutoff, or an object (i.e. a p5.Oscillator)
     *                              that can be used to modulate this
     *     parameter.
     *                              High numbers (i.e. 15) will produce a
     *     resonance, low numbers (i.e. .2) will produce a slope.
     */
 ...
 *  @param  {Function} [errorCallback] function to call if loading is not
 *     successful. A custom error will be passed in as the argument to the
 *     callback function.
 *  @return {p5.Convolver}
 *  @example
 *  <div><code>
 ...
 *  @param {Number} [tatums] Divisions of a beat, e.g. use 1/4, or 0.25 for a
 *     quater note (default is 1/16, a sixteenth note)
 *  @example
 *  <div><code>
 *  let box, drum, myPart;
 ...
 * @constructor
 *
 * @param {Function} callback this function will be called on each iteration of
 *     theloop
 * @param {Number|String} [interval] amount of time (if a number) or beats (if
 *     a string, following <a href =
...
function () {
  function SoundLoop(callback, interval) {
     ...
     * clock's frequency, that will be reflected after the next callback beats
     ...
     * modify these only when the interval is specified in musicalTime format
     * as a string
     */
  ...
  soundLoop_createClass(SoundLoop, [{
     ...
     * synchronization or to start a loop in synchronization with a loop that
     * is already playing This method will schedule the implicit loop in sync
     * with the explicit master loop i.e.
     * loopToStart.syncedStart(loopToSyncWith)
     *
     * @method  syncedStart
     * @for p5.SoundLoop
     * @param  {Object} otherLoop   a p5.SoundLoop to sync with
     * @param  {Number} [timeFromNow] Start the loops in sync after timeFromNow
     *     seconds
     */
    ...
    /**
     * Calculate the frequency of the clock's callback based on bpm, interval,
     * and timesignature
     * @private
     * @for p5.SoundLoop
     * @method  _calcFreq
...
function (_Effect) {
   ...
   *
   * @param {Number} [attack]     The amount of time (in seconds) to reduce the
   *     gain by 10dB, default = .003, range 0 - 1
   * @param {Number} [knee]       A decibel value representing the range above
   *     the threshold where the curve smoothly transitions to the "ratio"
   *     portion. default = 30, range 0 - 40
   * @param {Number} [ratio]      The amount of dB change in input for a 1 dB
   *     change in output default = 12, range 1 - 20
   * @param {Number} [threshold]  The decibel value above which the compression
   *     will start taking effect default = -24, range -100 - 0
   * @param {Number} [release]    The amount of time (in seconds) to increase
   *     the gain by 10dB default = .25, range 0 - 1
   */
  ...
  compressor_createClass(Compressor, [{
     ...
     * @method attack
     * @for p5.Compressor
     * @param {Number} [attack] Attack is the amount of time (in seconds) to
     *     reduce the gain by 10dB, default = .003, range 0 - 1
     * @param {Number} [time]  Assign time value to schedule the change in
     *     value
     */
     ...
     *                        threshold where the curve smoothly transitions to
     *     the "ratio" portion. default = 30, range 0 - 40
     * @param {Number} [time]  Assign time value to schedule the change in
     *     value
     */
     ...
     * @method reduction
     * @for p5.Compressor
     * @return {Number} Value of the amount of gain reduction that is applied
     *     to the signal
     */
 ...
 *                            scaled logarithmically where 0.1 is 1/2 the
 *     loudness of 1.0. Defaults to 0.35.
 ...
 * [Kevin
 * Ennis](http://stackoverflow.com/questions/22312841/waveshaper-node-in-webaudio-how-to-emulate-distortion)
 *
 * This class extends <a href = "/reference/#/p5.Effect">p5.Effect</a>.
 * Methods <a href = "/reference/#/p5.Effect/amp">amp()</a>, <a href =
 * "/reference/#/p5.Effect/chain">chain()</a>,
 ...
 *       *  control of sound1 var sound1Volume =
 *     constrain(map(mouseX,width,0,0,1), 0, 1); var sound2Volume =
 *     1-sound1Volume; sound1Gain.amp(sound1Volume);
 *     sound2Gain.amp(sound2Volume);
 *    // map the vertical position of the mouse to values useable for 'output
 *      *  volume control' var outputVolume =
 *     constrain(map(mouseY,height,0,0,1), 0, 1); mixGain.amp(outputVolume);
 *     text('output', width/2, height - outputVolume * height * 0.9) fill(255,
 *     0, 255); textAlign(LEFT); text('sound1', 5, height - sound1Volume *
 *     height * 0.9); textAlign(RIGHT); text('sound2', width - 5, height -
 *     sound2Volume * height * 0.9);
 *  }
 *</code></div>
 */
...
function (_AudioVoice) {
   ...
   *                                 value in Note/Octave format ("C4",
   *     "Eb3"...etc") See <a href =
   *     "https://github.com/Tonejs/Tone.js/wiki/Instruments"> Tone</a>.
   *     Defaults to 440 hz.
   *  @param  {Number} [velocity] velocity of the note to play (ranging from 0
   *     to 1)
   *  @param  {Number} [secondsFromNow]  time from now (in seconds) at which to
   *     play
   *  @param  {Number} [sustainTime] time to sustain before releasing the
   *     envelope. Defaults to 0.15 seconds.
   *  @example
   *  <div><code>
   *  let monoSynth;
   *
  ...
  monosynth_createClass(MonoSynth, [{
     ...
     *     "https://github.com/Tonejs/Tone.js/wiki/Instruments"> Tone</a>.
     *     Defaults to 440 hz
     *  @param  {Number} [velocity] velocity of the note to play (ranging from
     *     0 to 1)
     *  @param  {Number} [secondsFromNow]  time from now (in seconds) at which
     *     to play
     *  @method  triggerAttack
     *  @for p5.MonoSynth
     *  @example
     ...
     *     releaseLevel, on a scale from 0 to 1, where 1.0 = attackLevel, 0.0 =
     *     releaseLevel. The susRatio determines the decayLevel and the level
     *     at which the sustain portion of the envelope will sustain. For
     *     example, if attackLevel is 0.4, releaseLevel is 0, and susAmt is
     *     0.5, the decayLevel would be 0.2. If attackLevel is increased to 1.0
     *     (using <code>setRange</code>), then decayLevel would increase
     *     proportionally, to become 0.5.
     *  @param {Number} [releaseTime]   Time in seconds from now (defaults to
     *     0)
     */
 ...
 *  @param {Number} threshold   Amplitude threshold between 0 (no energy) and 1
 *     (maximum)
 ...
 *                                 the AudioVoice class. Defaults to
 *     p5.MonoSynth
...
function () {
  function PolySynth(audioVoice, maxVoices) {
     ...
     * on the fly. While a note has been attacked, but not released, the value
     * of the key is the audiovoice which is generating that note. When notes
     * are released, the value of the key becomes undefined.
     * @property notes
     */
    ...
    /**
     * This value must only change as a note is attacked or released. Due to
     * delay and sustain times, Tone.TimelineSignal is required to schedule the
     * change in value.
     * @private
  ...
  polysynth_createClass(PolySynth, [{
     ...
     *  @method  play
     *  @for p5.PolySynth
     *  @param  {Number} [note] midi note to play (ranging from 0 to 127 - 60
     *     being a middle C)
     *  @param  {Number} [velocity] velocity of the note to play (ranging from
     *     0 to 1)
     *  @param  {Number} [secondsFromNow]  time from now (in seconds) at which
     ...
     * triggered. Using this method modifies the envelope of whichever
     * audiovoice is being used to play the desired note. The envelope should
     * be reset before noteRelease is called in order to prevent the modified
     * envelope from being used on other notes.
     *
     *  @method  noteADSR
     *  @for p5.PolySynth
     ...
     * of each monosynth so that all notes are played with this envelope.
     *
     *  @method  setADSR
     *  @for p5.PolySynth
     *  @param {Number} [attackTime]  Time (in seconds before envelope
     ...
     *  @method  noteAttack
     *  @for p5.PolySynth
     *  @param  {Number} [note]           midi note on which attack should be
     *     triggered.
     *  @param  {Number} [velocity]       velocity of the note to play (ranging
     *     from 0 to 1)/
     *  @param  {Number} [secondsFromNow] time from now (in seconds)
     *  @example
     *  <div><code>
     ...
     * Any time a new value is scheduled, it is necessary to increment all
     * subsequent scheduledValues after attack, and decrement all subsequent
     ...
     *  @for p5.PolySynth
     *  @param  {Number} [note]           midi note on which attack should be
     *     triggered. If no value is provided, all notes will be released.
     *  @param  {Number} [secondsFromNow] time to trigger the release
     *  @example
     *  <div><code>
     *  let polySynth = new p5.PolySynth();
